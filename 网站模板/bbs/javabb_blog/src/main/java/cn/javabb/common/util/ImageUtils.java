...
public class ImageUtils {
	...
	public static void main(String[] args) {
		...
		// 5-给图片添加文字水印：
		// 方法一：
		ImageUtils.pressText("e:/abc.jpg", "e:/abc_presstext.jpg","www.javabb.cn",null,null,200,40,0.5f);// 测试OK
		// 方法二：
		ImageUtils.pressText2("www.javabb.cn", "e:/abc.jpg", "e:/abc_pressText2.jpg", "黑体", 20, Color.red, 60, 2, 2, 0.2f);// 测试OK

		// 6-给图片添加图片水印：
		ImageUtils.pressImage("e:/abc2.png", "e:/abc.jpg", "e:/abc_pressImage.jpg", 0, 0, 0.5f);// 测试OK
	}
	 ...
	 * @throws IOException 
	 */
	public static void pressText(String srcImageFile, String destImageFile,String text, Font font, Color color, int x, int y,
			float alpha){
		try{
		Font dfont = (font == null) ? new Font("黑体", 20, 60) : font;
		...
		g.drawString(text, width-x, height-y);
		g.dispose();
	...
	public final static void pressText2(String pressText, String srcImageFile, String destImageFile, String fontName,
			...
			File img = new File(srcImageFile);
			pressText2( pressText, img, destImageFile, fontName,
	            fontStyle, color, fontSize, x, y, alpha);
	}
	/**
	 * 文字水印
	 * eg:ImageUtils.pressText2("www.javabb.cn", "e:/abc.jpg", "e:/abc_pressText2.jpg", "黑体", 20, Color.red, 60, 2, 2, 0.2f);
	 * @author QINB
	 * @param pressText
	 * @param srcFile
	 * @param destImageFile
	 ...
	 * @param alpha
	 */
	public final static void pressText2(String pressText, File srcFile, String destImageFile, String fontName,
        int fontStyle, Color color, int fontSize, int x, int y, float alpha){
	    try {
