<div style="padding:13px 10px 10px 3px; line-height:1.31em "><?php // Do not delete these lines
...
<p><input name="submit" type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/submit.png" id="submit" tabindex="5" />
