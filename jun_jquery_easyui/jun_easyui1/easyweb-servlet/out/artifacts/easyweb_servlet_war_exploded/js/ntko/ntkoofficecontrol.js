...
document.write(' codebase="../../js/OfficeControl.cab#version=5,0,1,8"   ');
document.write('" width="100%" height="100%">   ');
document.write('<param name="ProductCaption" value="合肥优尔科技">   ');
document.write('<param name="ProductKey" value="6C4F41014CEDC8DBC22A96AEEA0AB8B1A713B6BA">   ');
