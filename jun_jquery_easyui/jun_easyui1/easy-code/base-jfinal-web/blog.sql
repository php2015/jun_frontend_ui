CREATE DATABASE base_jfinal_web_demo;

USE base_jfinal_web_demo;
...
INSERT INTO `blog` VALUES ('1', 'base-jfinal-web Demo Title here', 'base-jfinal-web Demo Content here', 0, 0, 0,'TBR',0, 0,'TBR');
