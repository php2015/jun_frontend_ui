...
*
* jQuery EasyUI Generic Plugins Basic Library
...
(function ($, undefined) {
    ...
    // 更改 jQuery EasyUI 中 easyui-textbox 及其继承组件的非空验证提醒消息语言。
    //$.extend($.fn.validatebox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.textbox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.numberbox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.combo.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.combobox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.combotree.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.combogrid.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.datebox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.datetimebox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.spinner.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.numberspinner.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.timespinner.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.datetimespinner.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
    //$.extend($.fn.filebox.defaults, { missingMessage: $.fn.validatebox.defaults.missingMessage });
