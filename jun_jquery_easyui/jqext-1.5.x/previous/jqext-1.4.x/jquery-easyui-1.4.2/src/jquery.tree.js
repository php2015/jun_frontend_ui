...
(function ($) {
    ...
    function _11(_12) {
        ...
        _15.find("div.tree-node").draggable({
            disabled: false, revert: true, cursor: "pointer",
            proxy: function (_16) {
    ...
    $.fn.tree.parseOptions = function (_122) {
        var t = $(_122);
        return $.extend({}, $.parser.parseOptions(_122, [
            "url", "method", {
