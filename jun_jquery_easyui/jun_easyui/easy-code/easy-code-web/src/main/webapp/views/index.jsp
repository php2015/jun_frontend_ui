...
<head>
    ...
    <!-- Global CSS -->
    <link rel="stylesheet" href="/dist/lib/bootstrap/bootstrap.min.css">
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="/dist/plugins/font-awesome/css/font-awesome.css">
    <link rel="stylesheet" href="/dist/plugins/prism/prism.css">
    <!-- Theme CSS -->
    <link id="theme-style" rel="stylesheet" href="/dist/css/styles.css">
    ...
    <div class="container">
        <h1 class="logo pull-left">
            <a class="scrollto" href="#promo">
                <span class="logo-title">JEasy Code</span>
            </a>
        </h1><!--//logo-->
        <nav id="main-nav" class="main-nav navbar-right" role="navigation">
            ...
            <div class="navbar-collapse collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a class="scrollto" href="#license">授权</a></li>
                    <li class="nav-item last"><a class="scrollto" href="#contact">联系</a></li>
                </ul><!--//nav-->
            </div><!--//navabr-collapse-->
        </nav><!--//main-nav-->
    </div>
...
<section id="promo" class="promo section offset-header">
    <div class="container text-center">
        <h2 class="title">JEasy Code<span class="highlight">2.0</span></h2>
        <p class="intro">一款快速智能代码生成工具, 旨在为您解决一切生硬重复的工作, 同时生成后端接口的描述文档, 快速提高开发效率, 使前后端接口开发更加方便快捷.</p>
        <div class="btns">
            <a class="btn btn-cta-secondary" href="http://themes.3rdwavemedia.com/" target="_blank">Demo</a>
            <a class="btn btn-cta-primary" href="http://git.oschina.net/taomk/easy-code/repository/archive/master" target="_blank">Download</a>
        </div>
        <ul class="meta list-inline">
            <li><a href="http://git.oschina.net/taomk/easy-code" target="_blank">View on Git@OSC</a></li>
    ...
    <div class="container">
        <div class="contact-inner">
            ...
            <div class="author-message">
                <div class="profile">
                    <img class="img-responsive" src="/dist/images/profile.png" alt="" />
                </div><!--//profile-->
                <div class="speech-bubble">
...
<script type="text/javascript" src="/dist/plugins/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="/dist/lib/bootstrap/bootstrap.js"></script>
<script type="text/javascript" src="/dist/lib/jquery.scrollTo/jquery.scrollTo.js"></script>
<script type="text/javascript" src="/dist/plugins/prism/prism.js"></script>
