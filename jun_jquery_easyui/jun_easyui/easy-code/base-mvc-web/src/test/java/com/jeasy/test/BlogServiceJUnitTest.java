...
public class BlogServiceJUnitTest extends BaseJUnitTester4SpringContext {
    ...
    public void testFind() {
        blogService.find(Maps.<String, Object>newHashMap());
    ...
    public void testPage() {
        blogService.page(Maps.<String, Object>newHashMap(), 1, 2);
        log.info("================> Test blogService.page success");
    }

    @Test
    public void testCount() {
        blogService.count(Maps.<String, Object>newHashMap());
        log.info("================> Test blogService.count success");
    }

    @Test
    public void testGetFirst() {
        blogService.getFirst(Maps.<String, Object>newHashMap());
    ...
    public void testSaveSelective() {
        ...
        blogService.saveSelective(blog);
    ...
    public void testModifySelective() {
        ...
        blogService.modifySelective(blog);
    ...
    public void testRemoveByParams() {
        blogService.removeByParams(Maps.<String, Object>newHashMap());
