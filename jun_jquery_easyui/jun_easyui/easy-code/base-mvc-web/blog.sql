CREATE DATABASE base_mvc_web_demo;

USE base_mvc_web_demo;
...
INSERT INTO `blog` VALUES ('1', 'base-mvc-web Demo Title here', 'base-mvc-web Demo Content here', 0, 0, 0,'TBR',0, 0,'TBR');
