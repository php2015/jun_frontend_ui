...
public class IgnoredColumn {
    ...
    public boolean equals(Object obj) {
        if (obj == null || !(obj instanceof org.mybatis.generator.config.IgnoredColumn)) {
            return false;
        }

        return columnName.equals(((org.mybatis.generator.config.IgnoredColumn) obj).getColumnName());
    }
