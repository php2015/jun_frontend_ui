/*
 * Copyright 2008 The Apache Software Foundation Licensed under the Apache License, Version 2.0 (the "License"); you may
...
import com.virjar.ssmcodegen.internal.db.IntrospectedTable;
import com.virjar.ssmcodegen.model.java.Field;
import com.virjar.ssmcodegen.model.java.Interface;
import com.virjar.ssmcodegen.model.java.Method;
import com.virjar.ssmcodegen.model.java.TopLevelClass;
import com.virjar.ssmcodegen.model.xml.Document;
import com.virjar.ssmcodegen.model.xml.XmlElement;
...
/**
 * This interface defines methods that will be called at different times during the code generation process. These
 * methods can be used to extend or modify the generated code. Clients may implement this interface in its entirety, or
 ...
 * </ol>
 * 
 * Plugins are related to contexts - so each context will have its own set of plugins. If the same plugin is specified
 * in multiple contexts, then each context will hold a unique instance of the plugin.
 * <p>
 * Plugins are called, and initialized, in the same order they are specified in the configuration.
 * <p>
 * The clientXXX, modelXXX, and sqlMapXXX methods are called by the code generators. If you replace the default code
...
public interface Plugin {
    ...
    /**
     * 设置插件特有的属性,插件向context中注册各自的变量,变量将会存在独立的变量空间中。同时,如果使用
     * 了@DependencyPlugin声明了当前功能所依赖的其他插件,那么对应插件将会再之前进行调用。然后将依赖插件的变量传入 ,用于计算自己的变量。同时,也可以从Context中获取系统变量用于计算
     */
    Map<String, Object> pluginSetAttribute(Map<Class, Map<String, Object>> dependencyPluginAttrs);

    /**
     * @return 插件是否生效,如全局开关控制,或者依赖插件不生效导致插件不生效
     */
    ...
    /**
     * This method can be used to generate any additional Java file needed by your implementation. This method is called
     * once, after all other Java files have been generated.
     * 
     * @return a List of GeneratedJavaFiles - these files will be saved with the other files from this run.
     */
    List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles();

    /**
     * This method can be used to generate additional Java files needed by your implementation that might be related to
     * a specific table. This method is called once for every table in the configuration.
     * 
    ...
    /**
     * This method can be used to generate any additional XML file needed by your implementation. This method is called
     * once, after all other XML files have been generated.
     * 
     * @return a List of GeneratedXmlFiles - these files will be saved with the other files from this run.
     */
    List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles();

    /**
     * This method can be used to generate additional XML files needed by your implementation that might be related to a
     * specific table. This method is called once for every table in the configuration.
     * 
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return a List of GeneratedXmlFiles - these files will be saved with the other files from this run.
     */
    ...
    /**
     * This method is called when the entire client has been generated. Implement this method to add additional methods
     * or fields to a generated client interface or implementation.
     * 
     ...
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the interface should be generated, false if the generated interface should be ignored. In the
     *         case of multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
     ...
     * @param topLevelClass the partially implemented client implementation class. You can add additional imported
     *            classes to the implementation class if necessary.
     * @param introspectedTable The class containing information about the table as introspected from the database
     ...
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean clientInsertMethodGenerated(Method method, TopLevelClass topLevelClass,
            IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called when the selectByExampleWithBLOBs method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the selectByExampleWithoutBLOBs method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the updateByExampleSelective method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the updateByExampleWithBLOBs method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the updateByExampleWithoutBLOBs method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the updateByPrimaryKeySelective method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the updateByPrimaryKeyWithBLOBs method has been generated in the client implementation
     * class.
     * 
    ...
    /**
     * This method is called when the updateByPrimaryKeyWithoutBLOBs method has been generated in the client
     ...
     * 
     * @param method the generated countByExample method
     * @param interfaze the partially implemented client interface. You can add additional imported classes to the
     *            interface if necessary.
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the method should be generated, false if the generated method should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean clientCountByExampleMethodGenerated(Method method, Interface interfaze,
            IntrospectedTable introspectedTable);
    ...
    /**
     * This method is called when the selectAll method has been generated in the client interface. This method is only
     * generated by the simple runtime.
     * 
     ...
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean clientSelectAllMethodGenerated(Method method, TopLevelClass topLevelClass,
            IntrospectedTable introspectedTable);
     ...
     * @param topLevelClass the partially implemented model class. You can add additional imported classes to the
     *            implementation class if necessary.
     * @param introspectedColumn The class containing information about the column related to this field as introspected
     *            from the database
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @param modelClassType the type of class that the field is generated for
     * @return true if the field should be generated, false if the generated field should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    ...
    /**
     * This method is called after the primary key class is generated by the JavaModelGenerator. This method will only
     * be called if the table rules call for generation of a primary key class.
     * <p/>
     * This method is only guaranteed to be called by the Java model generators. Other user supplied generators may, or
     * may not, call this method.
     * 
     * @param topLevelClass the generated primary key class
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the class should be generated, false if the generated class should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean modelPrimaryKeyClassGenerated(TopLevelClass topLevelClass, IntrospectedTable introspectedTable);

    /**
     * This method is called after the base record class is generated by the JavaModelGenerator. This method will only
     * be called if the table rules call for generation of a base record class.
     * <p/>
     * This method is only guaranteed to be called by the default Java model generators. Other user supplied generators
    ...
    /**
     * This method is called after the record with BLOBs class is generated by the JavaModelGenerator. This method will
     * only be called if the table rules call for generation of a record with BLOBs class.
     * <p/>
     * This method is only guaranteed to be called by the default Java model generators. Other user supplied generators
     * may, or may not, call this method.
     * 
    ...
    /**
     * This method is called after the example class is generated by the JavaModelGenerator. This method will only be
     ...
     * 
     * @param sqlMap the generated file (containing the file name, package name, and project name)
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the sqlMap should be generated, false if the generated sqlMap should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
    boolean sqlMapGenerated(GeneratedXmlFile sqlMap, IntrospectedTable introspectedTable);

    /**
     * This method is called when the SqlMap document has been generated. This method can be used to add additional XML
     * elements the the generated document.
     * 
     * @param document the generated document (note that this is the MyBatis generator's internal Document class - not
     *            the w3c XML Document class)
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the document should be generated, false if the generated document should be ignored. In the case
     *         of multiple plugins, the first plugin returning false will disable the calling of further plugins. Also,
     *         if any plugin returns false, then the <tt>sqlMapGenerated</tt> method will not be called.
     */
    ...
    /**
     * This method is called when the resultMap with BLOBs element is generated - this resultMap will extend the base
     * resultMap.
     * 
     * @param element the generated &lt;resultMap&gt; element
     * @param introspectedTable The class containing information about the table as introspected from the database
    ...
    /**
     * This method is called when the SQL provider has been generated. Implement this method to add additional methods
     * or fields to a generated SQL provider.
     * 
     * @param topLevelClass the generated provider
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the provider should be generated, false if the generated provider should be ignored. In the case
     *         of multiple plugins, the first plugin returning false will disable the calling of further plugins.
     */
     ...
     * @param topLevelClass the partially generated provider class You can add additional imported classes to the class
     *            if necessary.
     * @param introspectedTable The class containing information about the table as introspected from the database
     * @return true if the method should be generated, false if the generated method should be ignored. In the case of
     *         multiple plugins, the first plugin returning false will disable the calling of further plugins.
