...
public class ExtendedDAOMethodNameCalculator implements DAOMethodNameCalculator {
    ...
    /**
     * 1. if this will be the only updateByPrimaryKey, then the result should be updateByPrimaryKey. 2. If the other
     * method is enabled, but there are seperate base and blob classes, then the method name should be
     * updateByPrimaryKey 3. Else the method name should be updateByPrimaryKeyWithoutBLOBs
     */
     ...
     * 1. if this will be the only updateByPrimaryKey, then the result should be updateByPrimaryKey. 2. If the other
     * method is enabled, but there are seperate base and blob classes, then the method name should be
     * updateByPrimaryKey 3. Else the method name should be updateByPrimaryKeyWithBLOBs
     */
    ...
    /**
     * 1. if this will be the only selectByExample, then the result should be selectByExample. 2. Else the method name
     * should be selectByExampleWithoutBLOBs
     */
    ...
    /**
     * 1. if this will be the only selectByExample, then the result should be selectByExample. 2. Else the method name
     * should be selectByExampleWithBLOBs
     */
