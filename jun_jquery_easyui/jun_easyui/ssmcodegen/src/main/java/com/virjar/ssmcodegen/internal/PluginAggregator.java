 ...
 * License.
 */
package com.virjar.ssmcodegen.internal;
...
/**
 * This class is for internal use only. It contains a list of plugins for the current context and is used to aggregate
 * plugins together. This class implements the rule that if any plugin returns "false" from a method, then no other
 * plugin is called.
 * <p>
 ...
 * @author Jeff Butler
 * @deprecated
 * @see com.virjar.ssmcodegen.plugin.PluginAggregator
 */
public final class PluginAggregator implements Plugin {
    ...
    @Override
    public Map<String, Object> pluginSetAttribute(Map<Class, Map<String, Object>> dependencyPluginAttrs) {

        return null;
    }

    @Override
    public boolean pluginValidate() {
        return false;
    }
