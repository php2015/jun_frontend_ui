 ...
 * License.
 */
package com.virjar.ssmcodegen.internal.util;
...
public class JavaBeansUtil {
     ...
     * JavaBeans rules:
     * 
     * eMail > geteMail() firstName > getFirstName() URL > getURL() XAxis > getXAxis() a > getA() B > invalid - this
     * method assumes that this is not the case. Call getValidPropertyName first. Yaxis > invalid - this method assumes
     * that this is not the case. Call getValidPropertyName first.
     * 
     * @param property
     ...
     * JavaBeans rules:
     * 
     * eMail > seteMail() firstName > setFirstName() URL > setURL() XAxis > setXAxis() a > setA() B > invalid - this
     * method assumes that this is not the case. Call getValidPropertyName first. Yaxis > invalid - this method assumes
     * that this is not the case. Call getValidPropertyName first.
     * 
     * @param property
