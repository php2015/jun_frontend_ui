 ...
 * License.
 */
package com.virjar.ssmcodegen.internal.util.messages;
...
public class Messages {
    private static final String BUNDLE_NAME = "com.virjar.ssmcodegen.internal.util.messages.messages"; //$NON-NLS-1$
