...
public interface ICommonService<T> {
	 ...
	 * @return 所有数据列表
	 */
	GridModel pageGrid(Pager pager);
	 ...
	 * @return 所有数据列表
	 */
	Pager pageByEntity(T entity, Pager pager);
	 ...
	 * @return 所有数据列表
	 */
	GridModel pageGridByEntity(T entity, Pager pager);
