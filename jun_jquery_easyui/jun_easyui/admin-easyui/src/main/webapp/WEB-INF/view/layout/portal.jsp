...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/portal.css" type="text/css"></link>
<script type="text/javascript">
	...
	$(function() {
		...
		$("#chartContainer").insertFusionCharts({
			swfUrl : "${pageContext.request.contextPath}/js/FusionCharts/Column2D.swf",
		...
		var myExportComponent = new FusionChartsExportObject("fcExporter1", "${pageContext.request.contextPath}/js/FusionCharts/FCExporter.swf");
		myExportComponent.Render("fcexpDiv");
		$("#chartContainer2").insertFusionCharts({
			swfUrl : "${pageContext.request.contextPath}/js/FusionCharts/MSColumn3D.swf",
			//dataSource: "js/FusionCharts/Data.xml",
			//dataFormat: "xmlurl",
			width : parseInt($(this).width() * 0.5) - 80,
			height : parseInt($(this).height() * 0.4),
		...
		/*$("#chartContainer3").insertFusionCharts({
			swfUrl: "js/FusionCharts/Pie3D.swf",
			//dataSource: "js/FusionCharts/Data.xml",
			//dataFormat: "xmlurl",
			width: parseInt($(this).width()*0.5)-80,
			height: parseInt($(this).height()*0.4),
...
<body>
	<div id="pp" style="position:relative;height: 800px">
		<div>
			<div title="每日订单量" id="chartContainer" closable="true"></div>
		</div>
		<div>
