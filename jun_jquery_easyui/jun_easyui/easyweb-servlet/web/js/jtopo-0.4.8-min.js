!function (window) {
    ...
    function b(c) {
        ...
        this.initialize = function () {
            ...
            if (stage && stage.curScene && stage.curScene.leftTextNode) {
                var curScene = stage.curScene;
                var textNode = curScene.leftTextNode;
                var canvas = $("#canvas");
                var x = (10 - canvas.width() / 2) / curScene.scaleX + canvas.width() / 2 - curScene.translateX;
                var y = (10 - canvas.height() / 2) / curScene.scaleY + canvas.height() / 2 - curScene.translateY;
                textNode.setLocation(x, y);

            }

            if (stage && stage.curScene && stage.curScene.rightTextNode) {
                var curScene = stage.curScene;
                var textNode = curScene.rightTextNode;
                var canvas = $("#canvas");
                var x = (canvas.width() -100 - canvas.width() / 2) / curScene.scaleX + canvas.width() / 2 - curScene.translateX;
                var y = (10 - canvas.height() / 2) / curScene.scaleY + canvas.height() / 2 - curScene.translateY;
    ...
    function f(b, c, g) {
        ...
        this.initialize = function (b, c, d) {
            ...
            i -= Math.PI / 2;
            var o = {x: k + f * Math.cos(i), y: l + f * Math.sin(i)}, p = {
