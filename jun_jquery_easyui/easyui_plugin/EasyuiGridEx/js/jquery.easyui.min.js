...
(function($) {
	function _a0(_a1) {
		...
		//添加自定義分頁按鈕
		function createCustomerBtn(btnStr){
			var btn=_a3.nav[btnStr];
			var btnc=$(btn.content);
			var app_content=btnc.appendTo(tr);
			app_content.wrap("<td></td>");
			app_content.unbind(".aa").bind("click.aa", function () {
				btn.handler.call(this,_a1,_a3);
			});
			return app_content;
		}
...
(function($) {
	...
	function _5f5(_6c3, _6c4) {
		...
		if (opts.pagination) {
			...
			eval("$.extend(_6c5, { '"+opts.pageName+"': opts.pageNumber, '"+opts.rowName+"': opts.pageSize});");
//			$.extend(_6c5, {
...
//			});
		...
		if (opts.sortName) {
			...
			//拓展自定义页数 显示个数 原 rows:10,page:10
			eval("$.extend(_6c5, { '"+opts.sortName+"': opts.sortName, '"+opts.orderName+"': opts.sortOrder});");
//			$.extend(_6c5, {
//				sort : opts.sortName,
