/** layui-plus-v1.0.0 MIT License By https://gitee.com/zqaq_520/layui-plus */
 ;layui.define(['form','jquery',"layer"], function(exports){
    ...
    if(window.sessionStorage.getItem('userFace') &&  $(".userAvatar").length > 0){
        $("#userFace").attr("src",layui.cache.base + window.sessionStorage.getItem('userFace'));
        $(".userAvatar").attr("src",layui.cache.base + $(".userAvatar").attr("src").split("images/")[0] + "images/" + window.sessionStorage.getItem('userFace').split("images/")[1]);
    }else{
        $("#userFace").attr("src", layui.cache.base + "images/face.jpg");
    }
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="' + layui.cache.base + 'images/face.jpg" class="userAvatar"/></div>'+
