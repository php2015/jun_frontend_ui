! function(e, t) {
	...
	var z = {
			menus: ["head", "bold", "fontSize", "fontName", "italic", "underline", "strikeThrough", "foreColor", "backColor", "link", "list", "justify", "quote", "emoticon", "image", "table", "video", "
			", "undo", "redo"],
	...
	f.prototype = {
					...
					tabs: [{
						...
						events: [{
							...
							fn: function() {
								var e = o("#" + i),
									A = e.val() || e.html();
								return A = a(A), "new" === n ? t._insertCode(A,document.getElementById("lang").value) : t._updateCode(A), !0
							}
						}]
					}]
				});
		...
		_insertCode: function(e,lang) {
			this.editor.cmd.do("insertHTML", "<pre><code class = "+lang+">" + e + "</code></pre><p><br></p>")
		},
						...
						if(C.open("POST", o), C.timeout = m, C.ontimeout = function() {
								...
								if(4 === C.readyState) {
									...
									if(f.customInsert || "0" == e.errno) {
										if(f.customInsert && "function" == typeof f.customInsert) f.customInsert(t.insertLinkImg.bind(t), e, n);
										else {
