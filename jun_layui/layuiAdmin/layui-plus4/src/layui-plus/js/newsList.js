layui.define(['form','layer','laydate','table','laytpl','globalConfig'], function(exports){
    var form = layui.form,
    ...
    var tableIns = table.render({
        elem: '#newsList',
        url : layui.globalConfig.rootPath + 'json/newsList.json',
        cellMinWidth : 95,
        page : true,
        height : "full-125",
        limit : 20,
    ...
    function addNews(edit){
        ...
        $(window).on("resize",function(){
            if(index)layui.layer.full(index);
        })
    }
