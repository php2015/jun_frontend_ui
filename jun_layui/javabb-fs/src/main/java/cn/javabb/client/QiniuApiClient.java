...
import cn.javabb.exception.QiniuUploadException;
...
public class QiniuApiClient extends BaseApiClient {
    ...
    public FileUploadResponse upload(InputStream is, String imageUrl) {
        ...
        this.createNewFileName(key, FileUploadPath.QINIU_BASE_PATH.getPath()+this.uploadType);
    ...
    public boolean removeFile(String key) {
        ...
        try {
            ...
            throw new FileUploadException("[" + this.storageType + "]删除文件发生异常：" + r.toString());
        }
    }
