...
<%@page import="com.webuploader.util.*"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN">
<html>
<head>
<meta charset="utf-8">
<title>A Simple Page with Webuploader</title>
</head>
<!-- webuploader -->
...
<body>
	...
	<script type="text/javascript" src="static/webuploader/jquery-1.11.1.js"></script>
    <script type="text/javascript" src="static/webuploader/md5.js"></script>
		...
		<script type="text/javascript">
            ...
            function getServer(type){   //测试用，根据不同类型的后端返回对应的请求地址
                switch(type){
                    ...
                    case "java": return "http://localhost:8080/springmvc-plupload/webuploader/fileUpload";
