...
CKEDITOR.dialog.add( 'hiddenfield', function( editor )
{
	return {
		...
		onShow : function()
		{
			...
			this.getContentElement('info','_cke_saved_name').setValue(element.getAttribute('title'));
			this.getContentElement('info','value').setValue(element.getAttribute('value'));
		},
		onOk : function()
		{
			...
			element.setAttribute( 'title', this.getValueOf('info','_cke_saved_name'));
